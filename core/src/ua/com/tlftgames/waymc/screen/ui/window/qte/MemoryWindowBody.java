...
public class MemoryWindowBody extends QTEWindowBody {
    ...
    private float timeOut = 2.1f;
    private float waitTimeOut = 2f;
    private int rowCount = 4;
    private int colCount = 4;
    private int cardCount = 0;
    private int successCardCount = 5;
    ...
    public MemoryWindowBody(PlaceWindowManager manager, int difficultLevel) {
        ...
        timeOut += difficultLevel * 0.1f;
        waitTimeOut -= (float) difficultLevel * 0.5;
        ...
        this.addActor(timer);
        this.addAction(sequence(delay(0.6f + waitTimeOut), new RunnableAction() {
            @Override
            public void run() {
                MemoryWindowBody.this.run = true;
            }
        }));
    }
